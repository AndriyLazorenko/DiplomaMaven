...
public class CSVParser {
    ...
    public CSVParser(Results res, ResultsProcessor adjustedFreq, boolean forR) {
        ...
        try {
            String templatePath;
            if (forR){
                 templatePath = "src/main/resources/ConfigFiles/OutputCSVTemplates/RTemplate.txt";
            } else {
                 templatePath = "src/main/resources/ConfigFiles/OutputCSVTemplates/ExcelTemplate.txt";
            }
    ...
    public String toCSV() {
        ...
        //Switch of formatting depending on csv for R or Excel
        if (forR) {
            return toCSVR();
        } else {
            return toCSVX();
    ...
    /**
     * Uses forCSV array of Strings created by constructor to produce a String of results
     * ready to be written in a .CSV file for R
     * @return String of results ready to be written in a .CSV file for R
     */

    private String toCSVR() {

        forCSV[1] = forCSV[1].replaceFirst(";;", ";" + results.getProperties().getProperty("AA_After") + ";");
        forCSV[2] = forCSV[2].replaceFirst(";;", ";" + results.getProperties().getProperty("AC_After") + ";");
        forCSV[3] = forCSV[3].replaceFirst(";;", ";" + results.getProperties().getProperty("AG_After") + ";");
        forCSV[4] = forCSV[4].replaceFirst(";;", ";" + results.getProperties().getProperty("AT_After") + ";");
        forCSV[5] = forCSV[5].replaceFirst(";;", ";" + results.getProperties().getProperty("CA_After") + ";");
        forCSV[6] = forCSV[6].replaceFirst(";;", ";" + results.getProperties().getProperty("CC_After") + ";");
        forCSV[7] = forCSV[7].replaceFirst(";;", ";" + results.getProperties().getProperty("CG_After") + ";");
        forCSV[8] = forCSV[8].replaceFirst(";;", ";" + results.getProperties().getProperty("CT_After") + ";");
        forCSV[9] = forCSV[9].replaceFirst(";;", ";" + results.getProperties().getProperty("GA_After") + ";");
        forCSV[10] = forCSV[10].replaceFirst(";;", ";" + results.getProperties().getProperty("GC_After") + ";");
        forCSV[11] = forCSV[11].replaceFirst(";;", ";" + results.getProperties().getProperty("GG_After") + ";");
        forCSV[12] = forCSV[12].replaceFirst(";;", ";" + results.getProperties().getProperty("GT_After") + ";");
        forCSV[13] = forCSV[13].replaceFirst(";;", ";" + results.getProperties().getProperty("TA_After") + ";");
        forCSV[14] = forCSV[14].replaceFirst(";;", ";" + results.getProperties().getProperty("TC_After") + ";");
        forCSV[15] = forCSV[15].replaceFirst(";;", ";" + results.getProperties().getProperty("TG_After") + ";");
        forCSV[16] = forCSV[16].replaceFirst(";;", ";" + results.getProperties().getProperty("TT_After") + ";");
        ...
        forCSV[1] = forCSV[1].replaceFirst("1/16", adjustedFreq.getFrequencies().get("aaFreq"));
        forCSV[2] = forCSV[2].replaceFirst("1/16", adjustedFreq.getFrequencies().get("acFreq"));
        forCSV[3] = forCSV[3].replaceFirst("1/16", adjustedFreq.getFrequencies().get("agFreq"));
        forCSV[4] = forCSV[4].replaceFirst("1/16", adjustedFreq.getFrequencies().get("atFreq"));
        forCSV[5] = forCSV[5].replaceFirst("1/16", adjustedFreq.getFrequencies().get("caFreq"));
        forCSV[6] = forCSV[6].replaceFirst("1/16", adjustedFreq.getFrequencies().get("ccFreq"));
        forCSV[7] = forCSV[7].replaceFirst("1/16", adjustedFreq.getFrequencies().get("cgFreq"));
        forCSV[8] = forCSV[8].replaceFirst("1/16", adjustedFreq.getFrequencies().get("ctFreq"));
        forCSV[9] = forCSV[9].replaceFirst("1/16", adjustedFreq.getFrequencies().get("gaFreq"));
        forCSV[10] = forCSV[10].replaceFirst("1/16", adjustedFreq.getFrequencies().get("gcFreq"));
        forCSV[11] = forCSV[11].replaceFirst("1/16", adjustedFreq.getFrequencies().get("ggFreq"));
        forCSV[12] = forCSV[12].replaceFirst("1/16", adjustedFreq.getFrequencies().get("gtFreq"));
        forCSV[13] = forCSV[13].replaceFirst("1/16", adjustedFreq.getFrequencies().get("taFreq"));
        forCSV[14] = forCSV[14].replaceFirst("1/16", adjustedFreq.getFrequencies().get("tcFreq"));
        forCSV[15] = forCSV[15].replaceFirst("1/16", adjustedFreq.getFrequencies().get("tgFreq"));
        forCSV[16] = forCSV[16].replaceFirst("1/16", adjustedFreq.getFrequencies().get("ttFreq"));

        /*This block substitutes 'abs' symbols from template for absolute values of dinucleotide
         occurrence */

        forCSV[1] = forCSV[1].replace("abs", adjustedFreq.getResults().get("aa").toString());
        forCSV[2] = forCSV[2].replace("abs", adjustedFreq.getResults().get("ac").toString());
        forCSV[3] = forCSV[3].replace("abs", adjustedFreq.getResults().get("ag").toString());
        forCSV[4] = forCSV[4].replace("abs", adjustedFreq.getResults().get("at").toString());
        forCSV[5] = forCSV[5].replace("abs", adjustedFreq.getResults().get("ca").toString());
        forCSV[6] = forCSV[6].replace("abs", adjustedFreq.getResults().get("cc").toString());
        forCSV[7] = forCSV[7].replace("abs", adjustedFreq.getResults().get("cg").toString());
        forCSV[8] = forCSV[8].replace("abs", adjustedFreq.getResults().get("ct").toString());
        forCSV[9] = forCSV[9].replace("abs", adjustedFreq.getResults().get("ga").toString());
        forCSV[10] = forCSV[10].replace("abs", adjustedFreq.getResults().get("gc").toString());
        forCSV[11] = forCSV[11].replace("abs", adjustedFreq.getResults().get("gg").toString());
        forCSV[12] = forCSV[12].replace("abs", adjustedFreq.getResults().get("gt").toString());
        forCSV[13] = forCSV[13].replace("abs", adjustedFreq.getResults().get("ta").toString());
        forCSV[14] = forCSV[14].replace("abs", adjustedFreq.getResults().get("tc").toString());
        forCSV[15] = forCSV[15].replace("abs", adjustedFreq.getResults().get("tg").toString());
        forCSV[16] = forCSV[16].replace("abs", adjustedFreq.getResults().get("tt").toString());
        forCSV[17] = forCSV[17].replace("abs", adjustedFreq.getResults().get("total").toString());


        /*The block substitutes ;; symbols in the pattern with number of occurrences of corresponding
        dinucleotides before SNP*/

        forCSV[1] = forCSV[1].replace(";;", ";" + results.getProperties().getProperty("AA_before") + ";");
        forCSV[2] = forCSV[2].replace(";;", ";" + results.getProperties().getProperty("AC_before") + ";");
        forCSV[3] = forCSV[3].replace(";;", ";" + results.getProperties().getProperty("AG_before") + ";");
        forCSV[4] = forCSV[4].replace(";;", ";" + results.getProperties().getProperty("AT_before") + ";");
        forCSV[5] = forCSV[5].replace(";;", ";" + results.getProperties().getProperty("CA_before") + ";");
        forCSV[6] = forCSV[6].replace(";;", ";" + results.getProperties().getProperty("CC_before") + ";");
        forCSV[7] = forCSV[7].replace(";;", ";" + results.getProperties().getProperty("CG_before") + ";");
        forCSV[8] = forCSV[8].replace(";;", ";" + results.getProperties().getProperty("CT_before") + ";");
        forCSV[9] = forCSV[9].replace(";;", ";" + results.getProperties().getProperty("GA_before") + ";");
        forCSV[10] = forCSV[10].replace(";;", ";" + results.getProperties().getProperty("GC_before") + ";");
        forCSV[11] = forCSV[11].replace(";;", ";" + results.getProperties().getProperty("GG_before") + ";");
        forCSV[12] = forCSV[12].replace(";;", ";" + results.getProperties().getProperty("GT_before") + ";");
        forCSV[13] = forCSV[13].replace(";;", ";" + results.getProperties().getProperty("TA_before") + ";");
        forCSV[14] = forCSV[14].replace(";;", ";" + results.getProperties().getProperty("TC_before") + ";");
        forCSV[15] = forCSV[15].replace(";;", ";" + results.getProperties().getProperty("TG_before") + ";");
        forCSV[16] = forCSV[16].replace(";;", ";" + results.getProperties().getProperty("TT_before") + ";");

        forCSV[17] = forCSV[17].replaceAll("after", results.getProperties().getProperty("Sum_After"));
        forCSV[17] = forCSV[17].replaceAll("before", results.getProperties().getProperty("Sum_Before"));
        forCSV[18] = forCSV[18].replace("diff_before", results.getProperties().getProperty("Diff_Before"));
        forCSV[18] = forCSV[18].replace("diff_after", results.getProperties().getProperty("Diff_After"));
        forCSV[19] = forCSV[19].replace("total_snp", results.getProperties().getProperty("Total"));
    ...
    /**
     * Uses forCSV array of Strings created by constructor to produce a String of results
     * ready to be written in a .CSV file for Excel
     * @return String of results ready to be written in a .CSV file for Excel
     */

    private String toCSVX() {
        forCSV[0] = forCSV[0];
